...
import '../features/articles/models/blogpost_response_model.dart';
...
class BloomService {
  ...
  Future<BlogPostResponseModel> getBlogPosts() async {
    try {
      final response = await client.get(
          Uri.parse("https://bloom1.onrender.com/blogpost"));
      Map<String, dynamic> result = json.decode(response.body);
      log(response.body);
      return BlogPostResponseModel.fromJson(result);
    } catch (e) {
      return BlogPostResponseModel(sys: Sys(type: ""),
          total: 0,
          skip: 0,
          limit: 0,
          items: [],
